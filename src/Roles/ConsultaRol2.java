 ...
 * @author JossueG
 */
    public class ConsultaRol2 extends javax.swing.JFrame {

    private DefaultTableModel modeloTabla;
    
        public ConsultaRol2(String nombre, String cedula, String nomina, String periodo, String dependencia, 
                     String fechaInicio, String fechaFin, double sueldo, double bonificaciones, 
                     double descuentos, double valorNeto, String estadoPago) {
            initComponents();
        ...
        //Convertimos el estado del rol de pago a su descripción correspondiente
        String estadoPagoDescripcion;
        switch (estadoPago) {
        case "PEN":
            estadoPagoDescripcion = "Pendiente";
            break;
        case "PAG":
            estadoPagoDescripcion = "Pagado";
            break;
        case "INA":
            estadoPagoDescripcion = "Inactivo";
            break;
        default:
            estadoPagoDescripcion = "Desconocido"; 
        }

        EstadoRol.setText(estadoPagoDescripcion);
    ...
    private void imprimirRolDePago() {
        PrinterJob job = PrinterJob.getPrinterJob();
        job.setJobName("Impresión Rol de Pago");

        //Ocultar el botón antes de la impresión
        jButton1.setVisible(false);
        this.repaint(); // Redibujar la ventana sin el botón

        //Obtener dimensiones del JFrame y aumentar la resolución
        int originalWidth = this.getWidth();
        int originalHeight = this.getHeight();
        int dpiFactor = 3; //Factor de resolución para mejorar calidad (ajustable)
        int width = originalWidth * dpiFactor;
        int height = originalHeight * dpiFactor;
        ...
        //Ajustar la escala de dibujo antes de capturar la imagen
        g2d.scale(dpiFactor, dpiFactor);
        this.paint(g2d); //Dibujar la ventana en la imagen
        g2d.dispose();
        ...
        job.setPrintable(new Printable() {
            public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
                ...
                //Ajustar la escala de impresión dinámicamente
                double pageWidth = pageFormat.getImageableWidth();
                double pageHeight = pageFormat.getImageableHeight();
                double scaleX = pageWidth / width;
                double scaleY = pageHeight / height;
                double scaleFactor = Math.min(scaleX, scaleY); // Escala uniforme
        ...
        //Restaurar la visibilidad del botón después de imprimir
        jButton1.setVisible(true);
        this.repaint(); //Redibujar la ventana con el botón visible nuevamente
    }
    ...
    private void actualizarTotales() {
        ...
        //Calcular total neto (ingresos - descuentos)
    ...
    private void initComponents() {
        ...
        PrimerDia1 = new javax.swing.JLabel();
        EstadoRol = new javax.swing.JLabel();
        jButton1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Ver Rol de Pagos");
        ...
        jLabel1.setText("Ver Rol de Pagos");
        ...
        jPanelFechasCabeceraLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFechasCabeceraLayout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(UltimoDia, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanelEstado.setBackground(new java.awt.Color(51, 153, 255));

        PrimerDia1.setForeground(new java.awt.Color(255, 255, 255));
        PrimerDia1.setText("ESTADO:");

        EstadoRol.setForeground(new java.awt.Color(255, 255, 255));
        EstadoRol.setText("jLabel6");
        ...
        jPanelEstadoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelEstadoLayout.createSequentialGroup()
                .addGap(12, 12, 12)
                .addComponent(PrimerDia1, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
                .addComponent(EstadoRol, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanelEstadoLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelEstadoLayout.createSequentialGroup()
                ...
                .addGroup(jPanelEstadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(PrimerDia1)
                    .addComponent(EstadoRol)))
        );

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/simbolo-de-interfaz-de-impresion-de-una-maquina-impresora.png"))); // NOI18N
        ...
        jPanelFondoFacturaLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFondoFacturaLayout.createSequentialGroup()
                .addGroup(jPanelFondoFacturaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanelFondoFacturaLayout.createSequentialGroup()
                        .addGap(128, 128, 128)
        ...
        jPanelFondoFacturaLayout.setVerticalGroup(
            jPanelFondoFacturaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelFondoFacturaLayout.createSequentialGroup()
                .addGroup(jPanelFondoFacturaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanelFondoFacturaLayout.createSequentialGroup()
    ...
    private javax.swing.JLabel EstadoRol;
    ...
    private javax.swing.JLabel PrimerDia1;
