...
public class ModificarRol extends javax.swing.JFrame {
    ...
    String sql = "SELECT DISTINCT e.id_Empleado, TRIM(e.emp_Apellido1) AS apellido, TRIM(e.emp_Nombre1) AS nombre " +
                 ...
                 "WHERE p.ESTADO_PxE = 'PEN' " + //Solo roles pendientes
    ...
    private void initComponents() {
        ...
        titulo.setText("MODIFICAR ROL DE PAGOS");
    ...
    "d.dep_Nombre, p.id_Pago, pagos.pag_Fecha_Inicio, pagos.pag_Fecha_Fin, " +  
    ...
    //Pasar todos los parámetros al JFrame ModificarRol2
    ModificarRol2 modificarRol2 = new ModificarRol2(
        nombreCompleto.trim(), cedula, nomina, periodo, dependencia,
        fechaInicio, fechaFin, sueldo, bonificaciones, descuentos, valorNeto
    );
    modificarRol2.setVisible(true);
    this.dispose(); 
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró un rol de pago para este empleado.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    } catch (Exception ex) {
